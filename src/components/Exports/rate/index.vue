      ...
      <el-col :span="6">
        <el-card class="box-card1">
          <div slot="header" class="clearfix">
            <span>总出场人数： {{ page.sum }} 人</span>
          </div>
          <div class="text item">
            <el-table :data="page.sumList" height="330px" style=" font-size: 17px;">
              <el-table-column prop="name" label="日期" width="200" />
              <el-table-column prop="value" label="人数" width="200" />
            </el-table>
          </div>
        </el-card>
      </el-col>
...
import { getHeadcount } from '@/api/tf'
  ...
  methods: {
    ...
    drawChart() {
      ...
      getHeadcount(aId).then(res => {
        ...
        const stackedColumnPlotO = new Bar('area', {
          data: dataArea,
          isStack: true,
          xField: 'value',
          yField: 'time',
