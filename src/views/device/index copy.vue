  ...
  <div class="app-container">
    <el-card class="box-card" shadow="never">
      ...
      <el-form :inline="true" class="demo-form-inline" :size="'small'">
        <el-form-item label="设备名称">
          <el-input v-model="page.dName" placeholder="设备名称" />
        </el-form-item>
        <el-form-item label="设备IP">
          <el-input v-model="page.dIp" placeholder="设备IP" />
        </el-form-item>
        <el-form-item label="设备状态">
          <el-input v-model="page.dEnable" placeholder="设备IP" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="mt-3">
      ...
      >
        ...
        <el-table-column prop="dName" label="设备名称" />
...
export default {
  ...
  methods: {
    init() {
      ...
      const { current, size, dName, dIp, dEnable } = this.page
      getByKeys({ current, size, dName, dIp, dEnable }).then(res => {
