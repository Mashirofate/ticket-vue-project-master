...
<div>
    ...
    <el-form :model="form">
      <el-form-item label="身份证" >
        ...
        <el-input v-bind:value="form.aId" autocomplete="off" ></el-input>
    ...
    <el-button class="sweep" @click="media()">扫一扫</el-button>
    <el-button class="sweep">
  ...
  <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    ...
    <div slot="footer" >
      ...
      <el-button type="primary"    @click="dialogFormVisi(form.aId ) ">绑定</el-button>
    </div>
</div>
</template>
