...
export const constantRoutes = [
  ...
  },
  {
    ...
    name: '旧展示',
    hidden: true,
    component: () => import('@/views/exhibitionAaa/index'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'ticketing',
        name: '演唱会',
        component: () => import('@/views/dashboardVocal/index'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'es',
        name: '入场日志',
        component: () => import('@/views/enters/index'),
      ...
      },
      {
        path: 'ea',
        name: '区域座位信息',
        component: () => import('@/views/exhibitionActivities/index'),
        meta: { title: '区域座位信息', icon: 'component' }
      },
      {
        path: 'cc',
        name: '清楚卡',
        component: () => import('@/views/clearcard/index'),
        meta: { title: '清楚卡', icon: 'component' }
      },
      {
        path: 'ai',
        name: '区域通道',
        component: () => import('@/views/aisle/index'),
    ...
    children: [
      {
        path: 'fr',
        name: '人脸查询',
        component: () => import('@/views/facerefer/index'),
    ...
    children: [
      {
        path: 'tf',
        name: '活动入口报表',
        component: () => import('@/views/ticketforms/index'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('@/views/ticketforms/rate/index'),
        meta: { title: '活动入口打印', icon: 'dashboard' }
      },
      {
        path: 'et',
        name: '活动出口报表',
        component: () => import('@/views/exhibitionExport/index'),
      ...
      },
      {
        ...
        // hidden: true 表示不显示在菜单栏
        hidden: true,
        component: () => import('@/views/exhibitionExport/exports/index'),
  ...
  },
  {
    path: '/buyticket',
    component: Layout,
    redirect: '/buyticket/bt',
    name: '打印票务',
    meta: { title: '打印票务', icon: 'example' },
    children: [
      {
        path: 'tf',
        name: '单票务打印',
        component: () => import('@/views/OneBuyticket/index'),
        meta: { title: '单票务打印', icon: 'skill' }
      },
      {
        path: 'et',
        name: '多票务打印',
        component: () => import('@/views/MoreBuyticket/index'),
        meta: { title: '多票务打印', icon: 'skill' }
      }
    ]
  },
  {
